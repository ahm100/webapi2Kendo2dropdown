...
namespace MyEshop.Areas.Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,RoleID,UserName,Password,Email,IsActive")] Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,RoleID,UserName,Password,Email,ActiveCode,RegisterDate,IsActive")] Users users)
        {
            if (ModelState.IsValid)
            {
